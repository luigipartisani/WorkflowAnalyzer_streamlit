...
{
    public class WorkflowAdPreDsk : Workflow
    {
        ...
        public WorkflowAdPreDsk(string key, string title, Action<StateContext> drawPage) : base(key, title)
        {
            _DrawPage = drawPage;

            List<string> methods = ShowMethods(typeof(WorkflowAdPreDsk));
        ...
        private void _AddActivity_PrecSingoli(Workflow wf)
        {
            ...
            a.StaticInput = new Input(InputType.Multiple, new List<InputItem>(new InputItem[] {
                new InputItem("6008263", "6008263 - Prelievo ISA precompilato da Cassetto Fiscale", "6008263"),
                new InputItem("6008253", "6008253 - Bolli su FE", "6008253"),
                new InputItem("6008243", "6008243 - Prelievo CU da Cassetto Fiscale", "6008243"),
                new InputItem("6008273", "6008273 - Prelievo Corrispettivi Telematici", "6008273"),
				new InputItem("6008403", "6008403 - Prelievo Precompilata PF", "6008403"),
			}));
            a.DrawPage = _DrawPage;
        ...
        private void _AddActivity_PrecBundle(Workflow wf)
        {
            ...
            //a.Description = "Breve descrizione...";
            a.StaticInput = new Input(InputType.Multiple, new List<InputItem>(new InputItem[] {
                //new InputItem("6008283", "6008283 - Bundle Adempimenti Precompilati", "6008283"),
                //new InputItem("6008313", "6008313 - Recupero automatico Fatture da Portale Fatture&Corrispettivi AdE", "6008313"),
				new InputItem("6008499", "6008499 - Bundle Adempimenti Precompilati 2025", "6008499"),
			}));
            a.DrawPage = _DrawPage;
