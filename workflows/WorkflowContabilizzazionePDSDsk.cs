...
{
    public class WorkflowContabilizzazionePDSDsk : Workflow
    {
        ...
        public WorkflowContabilizzazionePDSDsk(string key, string title, Action<StateContext> drawPage) : base(key, title)
        {
            _DrawPage = drawPage;

            List<string> methods = ShowMethods(typeof(WorkflowContabilizzazionePDSDsk));
        ...
        private void _AddActivity_Modulo(Workflow wf)
        {
            ...
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
                new InputItem("9330033","9330033 - Contabilizzazione fatture fino a 3 PdL","9330033"),
                new InputItem("9330053","9330053 - Contabilizzazione fatture fino a 5 PdL","9330053"),
                new InputItem("9330103","9330103 - Contabilizzazione fatture fino a 10 PdL","9330103"),
                new InputItem("9330993","9330993 - Contabilizzazione fatture oltre 10 PdL","9330993")
            }));
            a.DrawPage = _DrawPage;
        ...
        private void _AddActivity_ModuloAzi(Workflow wf)
        {
            ...
            a.Title = "Configurazione da attivare";
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
                new InputItem("9330013", "9330013 - Contabilizzazione fatture per azienda", "9330013"),
            }));
            a.DrawPage = _DrawPage;
