...
{
    public class WorkflowImpSogg : Workflow
    {
        ...
        public WorkflowImpSogg(string key, string title, Action<StateContext> drawPage, int tipoLicenza) : base(key, title)
        {
            _DrawPage = drawPage;

            List<string> methods = ShowMethods(typeof(WorkflowImpSogg));
        ...
        private void _AddActivity_TipoLicenza(Workflow wf)
        {
            ...
            switch (tipoLicenza)
            {
                ...
                case 1:
                case 2:
                    b1 = a.CreateBranchTo("attivaModulo");
                    break;
            }
        }
        ...
        private void _AddActivity_Soggetto(Workflow wf)
        {
            ...
            Branch b1 = a.CreateBranchTo("attivaModulo");
        }


        private void _AddActivity_Modulo(Workflow wf)
        {
            Activity a = wf.CreateActivity("attivaModulo");
            a.Title = "Che modulo desideri attivare?";
            a.Title = "Modulo da attivare";
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
                new InputItem("8808039", "8808039 - Imposta di Soggiorno", "8808039")
            }));
            a.DrawPage = _DrawPage;
