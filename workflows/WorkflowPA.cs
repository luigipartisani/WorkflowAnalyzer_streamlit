...
{
    public class WorkflowPA : Workflow
    {
        ...
        public WorkflowPA(string key, string title, Action<StateContext> drawPage/*, bool possiedeContratto*/, int tipoLicenza) : base(key, title)
        {
            _DrawPage = drawPage;
            ...
            List<string> methods = ShowMethods(typeof(WorkflowPA));
            ...
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[]
       {
        ...
        private void _AddActivity_TipoModuli(Workflow wf)
        {
            ...
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
                ...
                //new InputItem("CS", "Mantenimento conservazione"),
            }));
            a.DrawPage = _DrawPage;
