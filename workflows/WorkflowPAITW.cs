...
{
    public class WorkflowPAITW : Workflow
    {
        ...
        public WorkflowPAITW(string key, string title, Action<StateContext> drawPage, int tipoLicenza) : base(key, title)
        {
            _DrawPage = drawPage;

            this.tipoLicenza = tipoLicenza;

            List<string> methods = ShowMethods(typeof(WorkflowPAITW));
        ...
        private void _AddActivity_TipoLicenza(Workflow wf)
        {
            ...
            {
                b1 = a.CreateBranchTo("tipoModuli");
            }
        }
        ...
        private void _AddActivity_AttivaNSO(Workflow wf)
        {
            ...
            a.Title = "Vuoi creare un nuovo contratto e attivare il servizio NSO?";
            a.TestoRiepilogo = "Servizio NSO:";
            //a.Description = "Breve descrizione...";
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
                new InputItem("nso", "NSO")
            }));
            a.DrawPage = _DrawPage;
            a.AllowNoChoice = true;

            Branch b1 = a.CreateBranchTo("tipoSogg");
        }
        ...
        private void _AddActivity_NumeroPA(Workflow wf)
        {
            ...
            a.StaticInput = new Input(InputType.Multiple, new List<InputItem>(new InputItem[] {
                ...
                new InputItem("9119999", "9119999 - Fatture PA illimitate", "9119999")
            }));
            a.DrawPage = _DrawPage;
