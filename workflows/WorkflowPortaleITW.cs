...
{
    public class WorkflowPortaleITW : Workflow
    {
        ...
        public WorkflowPortaleITW(string key, string title, Action<StateContext> drawPage, int tipoLicenza) : base(key, title)
        {
            _DrawPage = drawPage;

            List<string> methods = ShowMethods(typeof(WorkflowPortaleITW));
        ...
        private void _AddActivity_B2BProfessionista(Workflow wf)
        {
            ...
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
                new InputItem("9900030", "9900030 - Portale digitale B2B singolo STUDIO 2.000 fatture.", "9900030"),
        ...
        private void _AddActivity_B2BAziendaAutonoma(Workflow wf)
        {
            ...
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
                new InputItem("9920032", "9920032 - Portale digitale B2B singola AZIENDA 500 fatture", "9920032"),
                new InputItem("9920033", "9920033 - Portale digitale B2B singola AZIENDA 1.000 fatture", "9920033"),
                //new InputItem("9920068", "9920068 - Portale dei Servizi B2B per Azienda Singola 1.000 ft.", "9920068"),
                new InputItem("9920030", "9920030 - Portale digitale B2B singola AZIENDA 2.000 fatture", "9920030"),
