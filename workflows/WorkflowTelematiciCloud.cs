...
{
    public class WorkflowTelematiciCloud : Workflow
    {
        ...
        public WorkflowTelematiciCloud(string key, string title, Action<StateContext> drawPage/*, bool possiedeContratto*/) : base(key, title)  //A.Lucchi(27/04/2021)
        {
            _DrawPage = drawPage;

            List<string> methods = ShowMethods(typeof(WorkflowTelematiciCloud));
            ...
            a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[]
       {
            ...
            //    b1 = a.CreateBranchTo("cloud.upgrade");
            //else
            // b1 = a.CreateBranchTo("cloud.tel");
        ...
        private void _AddActivity_TipoContratto(Workflow wf)
        {
            ...
            Branch b3 = a.CreateBranchTo("migrazioneET");
            b3.Condition.IfOutputContainsItem("migrazione");
        }
        ...
        //        new InputItem("entra", "Telematici Entratel", "6518003"),
        //        new InputItem("inps", "Telematici INPS", "6538003"),
        //        new InputItem("cciaa", "Telematici CCIAA", "6008183"),
        //        new InputItem("730", "Spese per 730 precompilato", "6008203"),
        //        new InputItem("anetie", "Adeguamenti Antielusione", "6548003"),
        //        new InputItem("ascrive", "Agenzia scrive", "6008333")
        //    }));
        //    a.DrawPage = _DrawPage;
        ...
        private void _AddActivity_TelematiciCloud(Workflow wf)
        {
            ...
            a.Title = "Quali moduli vuoi attivare? <span style='font-size:20px'>1 di 2</span>";  //A.Lucchi(27/04/2021)
        ...
        //        new InputItem("200a", "Ulteriore anagrafiche soggetto cliente al bundle consulenti del lavoro<br/>(ogni 200)", 200, "6508504"),
        //        new InputItem("6018233", "Gestione completa Agenzia Scrive – Civis per i licenziatari del modulo<br/>'Rateizzazione e scadenze'", "6018233"),
        //        new InputItem("6008143", "Attivazione sedi", "6008143"),
        //    }));
        //    a.DrawPage = _DrawPage;
        ...
        private void _AddActivity_TelematiciCloudUpgrade(Workflow wf)
        {
            ...
            //    new InputItem("6008169", "6008169 - Attivazione sedi", "6008169"),
            //}));

            //a.StaticInput = new Input(InputType.Edit, new List<InputItem>(new InputItem[] {
            //    new InputItem("{'Key':'tipoLicenza','Text':'6508503 - Modulo base per gestione ulteriore anagrafiche soggetto (ogni 500)','DataType':'dropDown','value':500,'Tag':6508503,'Style':'visible'}"),
            //    new InputItem("{'Key':'tipoLicenza','Text':'6008149 - Accesso utente operatore aggiuntivo','DataType':'integer', 'Tag':6008149, 'Style':'hidden'}"),
            //    new InputItem("{'Key':'tipoLicenza','Text':'6018239 - Upgrade alla gestione completa Agenzia Scrive - Civis','DataType':'integer','Tag':6018239,'Style':'hidden'}"),
            //    new InputItem("{'Key':'tipoLicenza','Text':'6008169 - Attivazione sedi','DataType':'integer','Tag':6008169,'Style':'hidden'}"),
            //}));

            //a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
            //    new InputItem("6508503","6508503 -Modulo base per gestione ulteriore anagrafiche soggetto (ogni 500)", "6508503"),
            //    new InputItem("6008149","6008149 -Accesso utente operatore aggiuntivo",                               "6008149"),
            //    new InputItem("6018239","6018239 -Upgrade alla gestione completa Agenzia Scrive - Civis",             "6018239"),
            //    new InputItem("6008169","6008169 -Attivazione sedi",                                                "6008169")
            //}));
        ...
        //    //a.Description = "Breve descrizione...";
        //    a.StaticInput = new Input(InputType.Multiple, new List<InputItem>(new InputItem[] {
        //        new InputItem("cassf", "Cassetto fiscale", "6008153", true),
        //        new InputItem("cat", "Dati catastali online", "6008123"),
        //        new InputItem("rate", "Rateizzazioni e scadenze", "6008213"),
        //        new InputItem("firma", "Firma autografa automatica", "6008133"),
        //        new InputItem("alle", "Archiviazione allegati", "6558003"),
        //        new InputItem("mail", "Invio e-mail massivo e mail merge", "6008173"),
        //        new InputItem("equi", "Modulo Equitalia", "6568003")
        //    }));
        //    a.AllowNoChoice = true;
        //    a.DrawPage = _DrawPage;
        ...
        private void _AddActivity_ModuliEntratelCloud(Workflow wf)
        {
            ...
            a.Title = "Quali moduli vuoi attivare? <span style='font-size:20px'>2 di 2</span>";
            a.TestoRiepilogo = "Moduli da attivare:";
            //a.Description = "Breve descrizione...";
            a.StaticInput = new Input(InputType.Multiple, new List<InputItem>(new InputItem[] {
				...
				new InputItem("CPB.ET", "CPB.ET - Recupero CPB comunicazioni AdE","CPB.ET")
			}));
            a.AllowNoChoice = true;
            a.DrawPage = _DrawPage;
        ...
        //    //a.Description = "Breve descrizione...";
        //    a.StaticInput = new Input(InputType.Single, new List<InputItem>(new InputItem[] {
        //        new InputItem("cassp", "Cassetto previdenziale", "6008193"),
        ...
        //    a.StaticInput = new Input(InputType.Multiple, new List<InputItem>(new InputItem[]
        //    {
        //        new InputItem("6000014","Bundle Tuttok per Enti pubblici", "6518003;6538003"),
        //        new InputItem("6000024", "Bundle Tuttok per Consulenti del lavoro", "6508504;6518003;6538003" ),
        //        new InputItem("29780031", "Bundle Tuttok per Amministratori di condominio", "6508504;6518003;6538003")
        //    }));
        ...
        //        new InputItem("500a", "500 anagrafiche", 500, "6508503"),
        //        new InputItem("200a", "200 anagrafiche", 200, "6508504")
        //    }));
        //    a.DrawPage = _DrawPage;
        ...
        //    //a.Description = "Breve descrizione...";
        //    a.StaticInput = new Input(InputType.Numerical, new List<InputItem>(new InputItem[] {
        //        new InputItem("500a", "6008019 - 500 anagrafiche", 500, "6008019"),  //Manca
